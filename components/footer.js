export default function Footer() {
  return (
    <footer className="relative z-10 bg-black px-16 text-white pt-20  lg:pt-[120px] ">
          ...
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="text-body-color mb-7 text-base">
                We provide 2D & 3D animations to help explain and present your
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                ...
                <li>
                  <a
                    href="javascript:void( window.open( 'https://form.jotform.com/231294780271457', 'blank', 'scrollbars=yes, toolbar=no, width=700, height=500' ) ) "
                    className="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose"
                  >
                    Contact & Support
                  </a>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                ...
                <a
                  target="_blank"
                  href="https://www.linkedin.com/company/goanimatics/"
                  className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  rel="noreferrer"
                >
                  <svg
              ...
              <p className="text-body-color text-base">
                &copy; 2023 Goanimatics
              </p>
              <p className="text-body-color text-base">Powered by Sardor</p>
            </div>
          </div>
        </div>
      </div>
