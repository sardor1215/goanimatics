...
export default function Popup() {
  return (
    <div className="text-white fixed top-20 right-2  bg-white rounded-3xl transform hover:shadow-2xl  hover:scale-105 transition duration-200 ease-in z-10">
      <button
        type="button"
      ...
      >
        <a href="javascript:void( window.open( 'https://form.jotform.com/231294780271457', 'blank', 'scrollbars=yes, toolbar=no, width=700, height=500' ) ) ">
          {" "}
          <svg
            fill="#ee1717"
            width="50px"
